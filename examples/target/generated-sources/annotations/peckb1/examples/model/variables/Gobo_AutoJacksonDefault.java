...
public final class Gobo_AutoJacksonDefault implements Gobo {
  ...
  private final int postcards;

  public Gobo_AutoJacksonDefault(RecursiveVariable.RecursiveVariableType type, Integer value,
      String name, Optional<RecursiveVariable> child, int postcards) {
    this.type = type;
    this.value = value;
    this.name = name;
    this.child = child;
  ...
  public int getFetchedPostcards() {
